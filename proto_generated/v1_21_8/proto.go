...
func (ret *PlayToClientSpawnInfo) Decode(r io.Reader) (err error) {
	...
	if PlayToClientSpawnInfoDeathPresent {
		...
		err = PlayToClientSpawnInfoDeathPresentValue.Location.Decode(r)
		if err != nil {
			return
		}
...
func (ret *PlayToClientPacketBundleDelimiter) Decode(r io.Reader) (err error) {
	return
}
...
func (ret *PlayToClientPacketMoveMinecart) Decode(r io.Reader) (err error) {
	...
	for range lPlayToClientPacketMoveMinecartSteps {
		...
		err = PlayToClientPacketMoveMinecartStepsElement.Movement.Decode(r)
		if err != nil {
			return
		}
...
func (ret *PlayToClientPacketPlayerInfo) Decode(r io.Reader) (err error) {
	...
	for range lPlayToClientPacketPlayerInfoData {
		...
		case true:
			var PlayToClientPacketPlayerInfoDataElementPlayerTrueTmp GameProfile
...
func (ret *PlayToServerPacket) Decode(r io.Reader) (err error) {
	...
	case "debug_sample_subscription":
		var PlayToServerPacketParamsDebugSampleSubscriptionTmp PlayToServerPacketDebugSampleSubscription
		err = PlayToServerPacketParamsDebugSampleSubscriptionTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToServerPacketParamsDebugSampleSubscriptionTmp
...
func (ret *PlayToServerPacketDebugSampleSubscription) Decode(r io.Reader) (err error) {
	ret.Type, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
...
func (ret *EntityMetadataEntry) Decode(r io.Reader) (err error) {
	...
	case "compound_tag":
		var EntityMetadataEntryValueCompoundTagTmp nbt.Anon
		err = EntityMetadataEntryValueCompoundTagTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Value = EntityMetadataEntryValueCompoundTagTmp
	case "cow_variant":
...
var EntityMetadataEntryTypeReverseMap = map[string]int32{"byte": 0, "int": 1, "block_pos": 10, "optional_block_pos": 11, "direction": 12, "optional_uuid": 13, "block_state": 14, "optional_block_state": 15, "compound_tag": 16, "particle": 17, "particles": 18, "villager_data": 19, "long": 2, "optional_unsigned_int": 20, "pose": 21, "cat_variant": 22, "cow_variant": 23, "wolf_variant": 24, "wolf_sound_variant": 25, "frog_variant": 26, "pig_variant": 27, "chicken_variant": 28, "optional_global_pos": 29, "float": 3, "painting_variant": 30, "sniffer_state": 31, "armadillo_state": 32, "vector3": 33, "quaternion": 34, "string": 4, "component": 5, "optional_component": 6, "item_stack": 7, "boolean": 8, "rotations": 9}
...
func (ret *EntityMetadataEntry) Encode(w io.Writer) (err error) {
	...
	case "chicken_variant":
		...
		case string:
			...
			err = proto_base.EncodeString(w, EntityMetadataEntryValueKnownType)
			if err != nil {
				return
			}
		default:
...
var ConfigurationToServerPacketNameMap = map[int32]string{0x00: "settings", 0x01: "cookie_response", 0x02: "custom_payload", 0x03: "finish_configuration", 0x04: "keep_alive", 0x05: "pong", 0x06: "resource_pack_receive", 0x07: "select_known_packs", 0x08: "custom_click_action"}
...
var ConfigurationToServerPacketNameReverseMap = map[string]int32{"settings": 0x00, "cookie_response": 0x01, "custom_payload": 0x02, "finish_configuration": 0x03, "keep_alive": 0x04, "pong": 0x05, "resource_pack_receive": 0x06, "select_known_packs": 0x07, "custom_click_action": 0x08}
