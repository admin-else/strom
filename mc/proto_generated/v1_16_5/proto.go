...
// source: minecraft-data/pc/1.16.2/protocol.json (sha256:d96a3c5a7a7ddf2105e23990c2471b3aeafe4a6975e0c9d7d7943b599af9dfb3)
...
func (ret *CommandNode) Decode(r io.ReadSeeker) (err error) {
	...
	ret.Flags.Unused = CommandNodeFlagsPacked >> 5 & 7
	...
	case 2:
		...
		CommandNodeExtraNodeData2Tmp.Parser, err = proto_base.DecodeString(r)
		if err != nil {
			return
		}
		...
		case "minecraft:entity_summon":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftEntitySummonTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftEntitySummonTmp
		...
		case "minecraft:item_enchantment":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftItemEnchantmentTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftItemEnchantmentTmp
		...
		case "minecraft:mob_effect":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftMobEffectTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftMobEffectTmp
		case "minecraft:nbt":
		...
		case "minecraft:nbt_compound_tag":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftNbtCompoundTagTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftNbtCompoundTagTmp
		...
		case "minecraft:range":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftRangeTmp struct {
				AllowDecimals bool
			}
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesMinecraftRangeTmp.AllowDecimals)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftRangeTmp
...
func (ret *CommandNode) Encode(w io.Writer) (err error) {
	...
	case 2:
		...
		err = proto_base.EncodeString(w, CommandNodeExtraNodeData.Parser)
		if err != nil {
			return
		}
		...
		case "minecraft:range":
			...
			err = binary.Write(w, binary.BigEndian, CommandNodeExtraNodeDataProperties.AllowDecimals)
			if err != nil {
				return
			}
		case "minecraft:resource":
...
func (ret *EntityMetadata) Decode(r io.ReadSeeker) (err error) {
	...
	for {
		...
		case 10:
			var EntityMetadataInnerValue10Tmp *Position
			var EntityMetadataInnerValue10TmpPresent bool
			err = binary.Read(r, binary.BigEndian, &EntityMetadataInnerValue10TmpPresent)
			if err != nil {
				return
			}
			if EntityMetadataInnerValue10TmpPresent {
				var EntityMetadataInnerValue10TmpPresentValue Position
				err = EntityMetadataInnerValue10TmpPresentValue.Decode(r)
				if err != nil {
					return
				}
				EntityMetadataInnerValue10Tmp = &EntityMetadataInnerValue10TmpPresentValue
			}
			entry.Value = EntityMetadataInnerValue10Tmp
		case 11:
			var EntityMetadataInnerValue11Tmp int32
			EntityMetadataInnerValue11Tmp, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue11Tmp
		case 12:
			var EntityMetadataInnerValue12Tmp *uuid.UUID
			var EntityMetadataInnerValue12TmpPresent bool
			err = binary.Read(r, binary.BigEndian, &EntityMetadataInnerValue12TmpPresent)
			if err != nil {
				return
			}
			if EntityMetadataInnerValue12TmpPresent {
				var EntityMetadataInnerValue12TmpPresentValue uuid.UUID
				_, err = io.ReadFull(r, EntityMetadataInnerValue12TmpPresentValue[:])
				if err != nil {
					return
				}
				EntityMetadataInnerValue12Tmp = &EntityMetadataInnerValue12TmpPresentValue
			}
			entry.Value = EntityMetadataInnerValue12Tmp
		case 13:
			var EntityMetadataInnerValue13Tmp int32
			EntityMetadataInnerValue13Tmp, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue13Tmp
		case 14:
			var EntityMetadataInnerValue14Tmp nbt.Tag
			err = EntityMetadataInnerValue14Tmp.Decode(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue14Tmp
		case 15:
			var EntityMetadataInnerValue15Tmp Particle
			err = EntityMetadataInnerValue15Tmp.Decode(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue15Tmp
		case 16:
			var EntityMetadataInnerValue16Tmp struct {
				VillagerType       int32
				VillagerProfession int32
				Level              int32
			}
			EntityMetadataInnerValue16Tmp.VillagerType, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			EntityMetadataInnerValue16Tmp.VillagerProfession, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			EntityMetadataInnerValue16Tmp.Level, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue16Tmp
		case 17:
			var EntityMetadataInnerValue17Tmp Optvarint
			err = EntityMetadataInnerValue17Tmp.Decode(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue17Tmp
		case 18:
			var EntityMetadataInnerValue18Tmp int32
			EntityMetadataInnerValue18Tmp, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue18Tmp
		case 2:
		...
		case 5:
			var EntityMetadataInnerValue5Tmp *string
			var EntityMetadataInnerValue5TmpPresent bool
			err = binary.Read(r, binary.BigEndian, &EntityMetadataInnerValue5TmpPresent)
			if err != nil {
				return
			}
			if EntityMetadataInnerValue5TmpPresent {
				var EntityMetadataInnerValue5TmpPresentValue string
				EntityMetadataInnerValue5TmpPresentValue, err = proto_base.DecodeString(r)
				if err != nil {
					return
				}
				EntityMetadataInnerValue5Tmp = &EntityMetadataInnerValue5TmpPresentValue
			}
			entry.Value = EntityMetadataInnerValue5Tmp
		case 6:
			var EntityMetadataInnerValue6Tmp Slot
			err = EntityMetadataInnerValue6Tmp.Decode(r)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue6Tmp
		case 7:
			var EntityMetadataInnerValue7Tmp bool
			err = binary.Read(r, binary.BigEndian, &EntityMetadataInnerValue7Tmp)
			if err != nil {
				return
			}
			entry.Value = EntityMetadataInnerValue7Tmp
		case 8:
			var EntityMetadataInnerValue8Tmp struct {
				Pitch float32
				Yaw   float32
				Roll  float32
			}
			err = binary.Read(r, binary.BigEndian, &EntityMetadataInnerValue8Tmp.Pitch)
			if err != nil {
				return
			}
			err = binary.Read(r, binary.BigEndian, &EntityMetadataInnerValue8Tmp.Yaw)
			if err != nil {
				return
			}
			err = binary.Read(r, binary.BigEndian, &EntityMetadataInnerValue8Tmp.Roll)
			if err != nil {
				return
			}
		...
		case 9:
			...
			err = EntityMetadataInnerValue9Tmp.Decode(r)
			if err != nil {
				return
			}
...
func (ret *EntityMetadata) Encode(w io.Writer) (err error) {
	for _, v := range ret.Val {
		...
		case 15:
			EntityMetadataValue, ok := v.Value.(Particle)
			if !ok {
				err = proto_base.BadTypeError
				return
			}
		...
		case 16:
			...
			err = proto_base.EncodeVarInt(w, EntityMetadataValue.VillagerType)
			if err != nil {
				return
			}
			err = proto_base.EncodeVarInt(w, EntityMetadataValue.VillagerProfession)
			if err != nil {
				return
			}
			err = proto_base.EncodeVarInt(w, EntityMetadataValue.Level)
			if err != nil {
				return
			}
		case 17:
			EntityMetadataValue, ok := v.Value.(Optvarint)
			if !ok {
				err = proto_base.BadTypeError
				return
			}
...
func (ret *Particle) Decode(r io.ReadSeeker) (err error) {
	...
	case 14:
		var ParticleData14Tmp struct {
			Red   float32
			Green float32
			Blue  float32
			Scale float32
		}
		err = binary.Read(r, binary.BigEndian, &ParticleData14Tmp.Red)
		if err != nil {
			return
		}
		err = binary.Read(r, binary.BigEndian, &ParticleData14Tmp.Green)
		if err != nil {
			return
		}
		err = binary.Read(r, binary.BigEndian, &ParticleData14Tmp.Blue)
		if err != nil {
			return
		}
		err = binary.Read(r, binary.BigEndian, &ParticleData14Tmp.Scale)
		if err != nil {
			return
		}
		ret.Data = ParticleData14Tmp
	case 23:
		var ParticleData23Tmp struct {
			BlockState int32
		}
		ParticleData23Tmp.BlockState, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		ret.Data = ParticleData23Tmp
	case 3:
		var ParticleData3Tmp struct {
			BlockState int32
		}
		ParticleData3Tmp.BlockState, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		ret.Data = ParticleData3Tmp
	case 34:
		var ParticleData34Tmp struct {
			Item Slot
		}
		err = ParticleData34Tmp.Item.Decode(r)
		if err != nil {
			return
		}
		ret.Data = ParticleData34Tmp
	default:
...
func (ret *Particle) Encode(w io.Writer) (err error) {
	...
	case 23:
		...
		err = proto_base.EncodeVarInt(w, ParticleData.BlockState)
		if err != nil {
			return
		}
	case 3:
	...
	case 34:
		...
		ParticleDataItemEncTmp := ParticleData.Item
		err = ParticleDataItemEncTmp.Encode(w)
		if err != nil {
			return
		}
	default:
...
var PlayToClientPacketNameReverseMap = map[string]int32{"spawn_entity": 0x00, "spawn_entity_experience_orb": 0x01, "spawn_entity_living": 0x02, "spawn_entity_painting": 0x03, "named_entity_spawn": 0x04, "animation": 0x05, "statistics": 0x06, "acknowledge_player_digging": 0x07, "block_break_animation": 0x08, "tile_entity_data": 0x09, "block_action": 0x0a, "block_change": 0x0b, "boss_bar": 0x0c, "difficulty": 0x0d, "chat": 0x0e, "tab_complete": 0x0f, "declare_commands": 0x10, "transaction": 0x11, "close_window": 0x12, "window_items": 0x13, "craft_progress_bar": 0x14, "set_slot": 0x15, "set_cooldown": 0x16, "custom_payload": 0x17, "named_sound_effect": 0x18, "kick_disconnect": 0x19, "entity_status": 0x1a, "explosion": 0x1b, "unload_chunk": 0x1c, "game_state_change": 0x1d, "open_horse_window": 0x1e, "keep_alive": 0x1f, "map_chunk": 0x20, "world_event": 0x21, "world_particles": 0x22, "update_light": 0x23, "login": 0x24, "map": 0x25, "trade_list": 0x26, "rel_entity_move": 0x27, "entity_move_look": 0x28, "entity_look": 0x29, "entity": 0x2a, "vehicle_move": 0x2b, "open_book": 0x2c, "open_window": 0x2d, "open_sign_entity": 0x2e, "craft_recipe_response": 0x2f, "abilities": 0x30, "combat_event": 0x31, "player_info": 0x32, "face_player": 0x33, "position": 0x34, "unlock_recipes": 0x35, "entity_destroy": 0x36, "remove_entity_effect": 0x37, "resource_pack_send": 0x38, "respawn": 0x39, "entity_head_rotation": 0x3a, "multi_block_change": 0x3b, "select_advancement_tab": 0x3c, "world_border": 0x3d, "camera": 0x3e, "held_item_slot": 0x3f, "update_view_position": 0x40, "update_view_distance": 0x41, "spawn_position": 0x42, "scoreboard_display_objective": 0x43, "entity_metadata": 0x44, "attach_entity": 0x45, "entity_velocity": 0x46, "entity_equipment": 0x47, "experience": 0x48, "update_health": 0x49, "scoreboard_objective": 0x4a, "set_passengers": 0x4b, "teams": 0x4c, "scoreboard_score": 0x4d, "update_time": 0x4e, "title": 0x4f, "entity_sound_effect": 0x50, "sound_effect": 0x51, "stop_sound": 0x52, "playerlist_header": 0x53, "nbt_query_response": 0x54, "collect": 0x55, "entity_teleport": 0x56, "advancements": 0x57, "entity_update_attributes": 0x58, "entity_effect": 0x59, "declare_recipes": 0x5a, "tags": 0x5b}
...
func (ret *PlayToClientPacketChat) Decode(r io.ReadSeeker) (err error) {
	...
	_, err = io.ReadFull(r, ret.Sender[:])
	if err != nil {
		return
	}
	return
...
func (ret *PlayToClientPacketDeclareRecipes) Decode(r io.ReadSeeker) (err error) {
	...
	for range lPlayToClientPacketDeclareRecipesRecipes {
		...
		case "minecraft:crafting_shaped":
			...
			lPlayToClientPacketDeclareRecipesRecipesElementDataMinecraftCraftingShapedTmpIngredients = PlayToClientPacketDeclareRecipesRecipesElementDataMinecraftCraftingShapedTmp.Height
			...
			for range lPlayToClientPacketDeclareRecipesRecipesElementDataMinecraftCraftingShapedTmpIngredients {
				...
				lPlayToClientPacketDeclareRecipesRecipesElementDataMinecraftCraftingShapedTmpIngredientsElement = PlayToClientPacketDeclareRecipesRecipesElementDataMinecraftCraftingShapedTmp.Width
		...
		case "minecraft:smithing":
			var PlayToClientPacketDeclareRecipesRecipesElementDataMinecraftSmithingTmp struct {
				Base     Ingredient
				Addition Ingredient
				Result   Slot
			}
			err = PlayToClientPacketDeclareRecipesRecipesElementDataMinecraftSmithingTmp.Base.Decode(r)
			if err != nil {
				return
			}
			err = PlayToClientPacketDeclareRecipesRecipesElementDataMinecraftSmithingTmp.Addition.Decode(r)
			if err != nil {
				return
			}
			err = PlayToClientPacketDeclareRecipesRecipesElementDataMinecraftSmithingTmp.Result.Decode(r)
			if err != nil {
				return
			}
			PlayToClientPacketDeclareRecipesRecipesElement.Data = PlayToClientPacketDeclareRecipesRecipesElementDataMinecraftSmithingTmp
...
func (ret *PlayToClientPacketDeclareRecipes) Encode(w io.Writer) (err error) {
	...
	for iPlayToClientPacketDeclareRecipesRecipes := range len(ret.Recipes) {
		...
		case "minecraft:smithing":
			...
			PlayToClientPacketDeclareRecipesRecipesInnerDataBaseEncTmp := PlayToClientPacketDeclareRecipesRecipesInnerData.Base
			err = PlayToClientPacketDeclareRecipesRecipesInnerDataBaseEncTmp.Encode(w)
			if err != nil {
				return
			}
			PlayToClientPacketDeclareRecipesRecipesInnerDataAdditionEncTmp := PlayToClientPacketDeclareRecipesRecipesInnerData.Addition
			err = PlayToClientPacketDeclareRecipesRecipesInnerDataAdditionEncTmp.Encode(w)
			if err != nil {
				return
			}
			PlayToClientPacketDeclareRecipesRecipesInnerDataResultEncTmp := PlayToClientPacketDeclareRecipesRecipesInnerData.Result
...
func (ret *PlayToClientPacketLogin) Decode(r io.ReadSeeker) (err error) {
	...
	err = ret.DimensionCodec.Decode(r)
	if err != nil {
		return
	}
	err = ret.Dimension.Decode(r)
	if err != nil {
		return
	}
	ret.WorldName, err = proto_base.DecodeString(r)
	if err != nil {
		return
	}
...
func (ret *PlayToClientPacketLogin) Encode(w io.Writer) (err error) {
	...
	PlayToClientPacketLoginDimensionCodecEncTmp := ret.DimensionCodec
	err = PlayToClientPacketLoginDimensionCodecEncTmp.Encode(w)
	if err != nil {
		return
	}
	PlayToClientPacketLoginDimensionEncTmp := ret.Dimension
	err = PlayToClientPacketLoginDimensionEncTmp.Encode(w)
	if err != nil {
		return
	}
	err = proto_base.EncodeString(w, ret.WorldName)
	if err != nil {
		return
	}
...
func (ret *PlayToClientPacketMapChunk) Decode(r io.ReadSeeker) (err error) {
	...
	switch ret.GroundUp {
	case false:
		var PlayToClientPacketMapChunkBiomesFalseTmp struct {
		}
		ret.Biomes = PlayToClientPacketMapChunkBiomesFalseTmp
	case true:
		var PlayToClientPacketMapChunkBiomesTrueTmp []int32
		var lPlayToClientPacketMapChunkBiomesTrueTmp int32
		lPlayToClientPacketMapChunkBiomesTrueTmp, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		PlayToClientPacketMapChunkBiomesTrueTmp = []int32{}
		for range lPlayToClientPacketMapChunkBiomesTrueTmp {
			var PlayToClientPacketMapChunkBiomesTrueTmpElement int32
			PlayToClientPacketMapChunkBiomesTrueTmpElement, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			PlayToClientPacketMapChunkBiomesTrueTmp = append(PlayToClientPacketMapChunkBiomesTrueTmp, PlayToClientPacketMapChunkBiomesTrueTmpElement)
		}
		ret.Biomes = PlayToClientPacketMapChunkBiomesTrueTmp
	}
...
func (ret *PlayToClientPacketMapChunk) Encode(w io.Writer) (err error) {
	...
	case true:
		PlayToClientPacketMapChunkBiomes, ok := ret.Biomes.([]int32)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
		err = proto_base.EncodeVarInt(w, int32(len(PlayToClientPacketMapChunkBiomes)))
		if err != nil {
			return
		}
		for iPlayToClientPacketMapChunkBiomes := range len(PlayToClientPacketMapChunkBiomes) {
			err = proto_base.EncodeVarInt(w, PlayToClientPacketMapChunkBiomes[iPlayToClientPacketMapChunkBiomes])
			if err != nil {
				return
			}
		}
...
func (ret *PlayToClientPacketMultiBlockChange) Decode(r io.ReadSeeker) (err error) {
	...
	ret.ChunkCoordinates.Y = uint32(PlayToClientPacketMultiBlockChangeChunkCoordinatesPacked >> 0 & 1048575)
	...
	err = binary.Read(r, binary.BigEndian, &ret.NotTrustEdges)
	if err != nil {
		return
	}
	...
	for range lPlayToClientPacketMultiBlockChangeRecords {
		var PlayToClientPacketMultiBlockChangeRecordsElement int64
		PlayToClientPacketMultiBlockChangeRecordsElement, err = proto_base.DecodeVarLong(r)
		if err != nil {
			return
		}
...
func (ret *PlayToClientPacketMultiBlockChange) Encode(w io.Writer) (err error) {
	...
	err = binary.Write(w, binary.BigEndian, ret.NotTrustEdges)
	if err != nil {
		return
	}
	...
	for iPlayToClientPacketMultiBlockChangeRecords := range len(ret.Records) {
		err = proto_base.EncodeVarLong(w, ret.Records[iPlayToClientPacketMultiBlockChangeRecords])
		if err != nil {
			return
		}
	}
...
func (ret *PlayToClientPacketRespawn) Encode(w io.Writer) (err error) {
	PlayToClientPacketRespawnDimensionEncTmp := ret.Dimension
	err = PlayToClientPacketRespawnDimensionEncTmp.Encode(w)
	if err != nil {
		return
	}
	err = proto_base.EncodeString(w, ret.WorldName)
...
func (ret *PlayToClientPacketUnlockRecipes) Decode(r io.ReadSeeker) (err error) {
	...
	err = binary.Read(r, binary.BigEndian, &ret.BlastFurnaceOpen)
	if err != nil {
		return
	}
	err = binary.Read(r, binary.BigEndian, &ret.FilteringBlastFurnace)
	if err != nil {
		return
	}
	err = binary.Read(r, binary.BigEndian, &ret.SmokerBookOpen)
	if err != nil {
		return
	}
	err = binary.Read(r, binary.BigEndian, &ret.FilteringSmoker)
	if err != nil {
		return
	}
...
func (ret *PlayToClientPacketUnlockRecipes) Encode(w io.Writer) (err error) {
	...
	err = binary.Write(w, binary.BigEndian, ret.BlastFurnaceOpen)
	if err != nil {
		return
	}
	err = binary.Write(w, binary.BigEndian, ret.FilteringBlastFurnace)
	if err != nil {
		return
	}
	err = binary.Write(w, binary.BigEndian, ret.SmokerBookOpen)
	if err != nil {
		return
	}
	err = binary.Write(w, binary.BigEndian, ret.FilteringSmoker)
	if err != nil {
		return
	}
...
func (ret *PlayToClientPacketUpdateLight) Decode(r io.ReadSeeker) (err error) {
	...
	err = binary.Read(r, binary.BigEndian, &ret.TrustEdges)
	if err != nil {
		return
	}
...
func (ret *PlayToClientPacketUpdateLight) Encode(w io.Writer) (err error) {
	...
	err = binary.Write(w, binary.BigEndian, ret.TrustEdges)
	if err != nil {
		return
	}
...
func (ret *PlayToClientPacketWorldParticles) Decode(r io.ReadSeeker) (err error) {
	...
	switch ret.ParticleId {
	case 14:
		var PlayToClientPacketWorldParticlesData14Tmp struct {
			Red   float32
			Green float32
			Blue  float32
			Scale float32
		}
		err = binary.Read(r, binary.BigEndian, &PlayToClientPacketWorldParticlesData14Tmp.Red)
		if err != nil {
			return
		}
		err = binary.Read(r, binary.BigEndian, &PlayToClientPacketWorldParticlesData14Tmp.Green)
		if err != nil {
			return
		}
		err = binary.Read(r, binary.BigEndian, &PlayToClientPacketWorldParticlesData14Tmp.Blue)
		if err != nil {
			return
		}
		err = binary.Read(r, binary.BigEndian, &PlayToClientPacketWorldParticlesData14Tmp.Scale)
		if err != nil {
			return
		}
		ret.Data = PlayToClientPacketWorldParticlesData14Tmp
	case 23:
		var PlayToClientPacketWorldParticlesData23Tmp struct {
			BlockState int32
		}
		PlayToClientPacketWorldParticlesData23Tmp.BlockState, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		ret.Data = PlayToClientPacketWorldParticlesData23Tmp
	case 3:
		var PlayToClientPacketWorldParticlesData3Tmp struct {
			BlockState int32
		}
		PlayToClientPacketWorldParticlesData3Tmp.BlockState, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		ret.Data = PlayToClientPacketWorldParticlesData3Tmp
	case 34:
		var PlayToClientPacketWorldParticlesData34Tmp struct {
			Item Slot
		}
		err = PlayToClientPacketWorldParticlesData34Tmp.Item.Decode(r)
		if err != nil {
			return
		}
		ret.Data = PlayToClientPacketWorldParticlesData34Tmp
	default:
...
func (ret *PlayToClientPacketWorldParticles) Encode(w io.Writer) (err error) {
	...
	switch ret.ParticleId {
	case 14:
		PlayToClientPacketWorldParticlesData, ok := ret.Data.(struct {
			Red   float32
			Green float32
			Blue  float32
			Scale float32
		...
		err = binary.Write(w, binary.BigEndian, PlayToClientPacketWorldParticlesData.Red)
		if err != nil {
			return
		}
		err = binary.Write(w, binary.BigEndian, PlayToClientPacketWorldParticlesData.Green)
		if err != nil {
			return
		}
		err = binary.Write(w, binary.BigEndian, PlayToClientPacketWorldParticlesData.Blue)
		if err != nil {
			return
		}
		err = binary.Write(w, binary.BigEndian, PlayToClientPacketWorldParticlesData.Scale)
		if err != nil {
			return
		}
	case 23:
		...
		err = proto_base.EncodeVarInt(w, PlayToClientPacketWorldParticlesData.BlockState)
		if err != nil {
			return
		}
	case 3:
	...
	case 34:
		...
		PlayToClientPacketWorldParticlesDataItemEncTmp := PlayToClientPacketWorldParticlesData.Item
		err = PlayToClientPacketWorldParticlesDataItemEncTmp.Encode(w)
		if err != nil {
			return
		}
	default:
...
func (ret *PlayToServerPacketDisplayedRecipe) Decode(r io.ReadSeeker) (err error) {
	ret.RecipeId, err = proto_base.DecodeString(r)
	if err != nil {
		return
	}
	return
...
func (ret *PlayToServerPacketDisplayedRecipe) Encode(w io.Writer) (err error) {
	err = proto_base.EncodeString(w, ret.RecipeId)
	if err != nil {
		return
	}
	return
