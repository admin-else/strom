...
// source: minecraft-data/pc/26.1/protocol.json (sha256:093dbdd74f2cfbc8fc6be2e6f26c6b4d35470771cb34691306c68b066d785529)
...
func (ret *PlayToServerPacket) Decode(r io.ReadSeeker) (err error) {
	...
	case "spectate_entity":
		var PlayToServerPacketParamsSpectateEntityTmp PlayToServerPacketSpectateEntity
		err = PlayToServerPacketParamsSpectateEntityTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToServerPacketParamsSpectateEntityTmp
	case "steer_boat":
...
func (ret *PlayToServerPacket) Encode(w io.Writer) (err error) {
	...
	case "spectate_entity":
		PlayToServerPacketParams, ok := ret.Params.(PlayToServerPacketSpectateEntity)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
...
type PlayToServerPacketSpectateEntity struct {
	EntityId int32
}

func (ret *PlayToServerPacketSpectateEntity) Decode(r io.ReadSeeker) (err error) {
	ret.EntityId, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
...
func (ret *PlayToServerPacketSpectateEntity) Encode(w io.Writer) (err error) {
	err = proto_base.EncodeVarInt(w, ret.EntityId)
	if err != nil {
		return
	}
