...
func (ret *Particle) Decode(r io.ReadSeeker) (err error) {
	...
	case 32:
		var ParticleData32Tmp struct {
			Item Slot
		}
		err = ParticleData32Tmp.Item.Decode(r)
		if err != nil {
			return
		}
		ret.Data = ParticleData32Tmp
	default:
...
func (ret *PlayToClientPacketWorldParticles) Decode(r io.ReadSeeker) (err error) {
	...
	case 32:
		var PlayToClientPacketWorldParticlesData32Tmp struct {
			Item Slot
		}
		err = PlayToClientPacketWorldParticlesData32Tmp.Item.Decode(r)
		if err != nil {
			return
		}
		ret.Data = PlayToClientPacketWorldParticlesData32Tmp
	default:
