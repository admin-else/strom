...
// source: minecraft-data/pc/26.2/protocol.json (sha256:7d1157fb503d364c1673400a847e470e08d4036181700423939571ea83ee561d)
...
func (ret *IDSet) Decode(r io.ReadSeeker) (err error) {
	var IDSetId int32
	IDSetId, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
	if IDSetId != 0 {
...
func (ret *IDSet) Encode(w io.Writer) (err error) {
	switch IDSetKnownType := ret.Val.(type) {
	case string:
		err = proto_base.EncodeVarInt(w, 0)
		if err != nil {
			return
		}
		err = proto_base.EncodeString(w, IDSetKnownType)
		if err != nil {
			return
		}
	case int32:
		err = proto_base.EncodeVarInt(w, IDSetKnownType)
		if err != nil {
			return
		}
	default:
...
func (ret *ItemBlockPredicate) Decode(r io.ReadSeeker) (err error) {
	...
	if ItemBlockPredicateBlockSetPresent {
		...
		var ItemBlockPredicateBlockSetId int32
		ItemBlockPredicateBlockSetId, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		if ItemBlockPredicateBlockSetId != 0 {
			ItemBlockPredicateBlockSetPresentValue = ItemBlockPredicateBlockSetId
		} else {
	...
	if ItemBlockPredicatePropertiesPresent {
		...
		var lItemBlockPredicateProperties int32
		lItemBlockPredicateProperties, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		...
		for range lItemBlockPredicateProperties {
			...
			err = ItemBlockPredicatePropertiesElement.Decode(r)
			if err != nil {
				return
			}
...
func (ret *ItemBlockPredicate) Encode(w io.Writer) (err error) {
	err = binary.Write(w, binary.BigEndian, ret.BlockSet != nil)
	if err != nil {
		return
	}
	if ret.BlockSet != nil {
		switch ItemBlockPredicateBlockSetKnownType := (*ret.BlockSet).(type) {
		case string:
			err = proto_base.EncodeVarInt(w, 0)
			if err != nil {
				return
			}
			err = proto_base.EncodeString(w, ItemBlockPredicateBlockSetKnownType)
			if err != nil {
				return
			}
		case int32:
			err = proto_base.EncodeVarInt(w, ItemBlockPredicateBlockSetKnownType)
			if err != nil {
				return
			}
		default:
	...
	err = binary.Write(w, binary.BigEndian, ret.Properties != nil)
	if err != nil {
		return
	}
	if ret.Properties != nil {
		...
		for iItemBlockPredicateProperties := range len(*ret.Properties) {
			ItemBlockPredicatePropertiesInnerEncTmp := (*ret.Properties)[iItemBlockPredicateProperties]
			err = ItemBlockPredicatePropertiesInnerEncTmp.Encode(w)
			if err != nil {
				return
			}
		}
	}
	ItemBlockPredicateNbtEncTmp := ret.Nbt
	err = ItemBlockPredicateNbtEncTmp.Encode(w)
	if err != nil {
		return
	}
	ItemBlockPredicateComponentsEncTmp := ret.Components
	err = ItemBlockPredicateComponentsEncTmp.Encode(w)
	if err != nil {
		return
	}
	return
...
func (ret *ChunkBlockEntity) Decode(r io.ReadSeeker) (err error) {
	...
	ret.Anon.Z = ChunkBlockEntityAnonPacked >> 0 & 15
	ret.Anon.X = ChunkBlockEntityAnonPacked >> 4 & 15
...
func (ret *CommandNode) Decode(r io.ReadSeeker) (err error) {
	...
	ret.Flags.CommandNodeType = CommandNodeFlagsPacked >> 0 & 3
	ret.Flags.HasCommand = CommandNodeFlagsPacked>>2&1 == 1
	ret.Flags.HasRedirectNode = CommandNodeFlagsPacked>>3&1 == 1
	ret.Flags.HasCustomSuggestions = CommandNodeFlagsPacked>>4&1 == 1
	ret.Flags.AllowsRestricted = CommandNodeFlagsPacked>>5&1 == 1
	...
	switch ret.Flags.CommandNodeType {
	case 0:
	...
	case 2:
		...
		var CommandNodeExtraNodeData2TmpParserKey int32
		CommandNodeExtraNodeData2TmpParserKey, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		CommandNodeExtraNodeData2Tmp.Parser, err = proto_base.ErroringIndex(CommandNodeExtraNodeData2TmpParserMap, CommandNodeExtraNodeData2TmpParserKey)
		if err != nil {
			return
		}
		switch CommandNodeExtraNodeData2Tmp.Parser {
		case "brigadier:bool":
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierBoolTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesBrigadierBoolTmp
		case "brigadier:double":
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp struct {
				Flags struct {
					Unused     uint8
					MaxPresent bool
					MinPresent bool
			...
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpFlagsPacked uint8
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpFlagsPacked)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Flags.MinPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpFlagsPacked>>0&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Flags.MaxPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpFlagsPacked>>1&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Flags.Unused = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpFlagsPacked >> 2 & 63
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Flags.MinPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMin1Tmp float64
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMin1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMin1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMinTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMinTmp
			}
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Flags.MaxPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMax1Tmp float64
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMax1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMax1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMaxTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmpMaxTmp
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesBrigadierDoubleTmp
		case "brigadier:float":
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp struct {
				Flags struct {
					Unused     uint8
					MaxPresent bool
					MinPresent bool
			...
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpFlagsPacked uint8
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpFlagsPacked)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Flags.MinPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpFlagsPacked>>0&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Flags.MaxPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpFlagsPacked>>1&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Flags.Unused = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpFlagsPacked >> 2 & 63
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Flags.MinPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMin1Tmp float32
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMin1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMin1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMinTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMinTmp
			}
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Flags.MaxPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMax1Tmp float32
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMax1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMax1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMaxTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmpMaxTmp
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesBrigadierFloatTmp
		case "brigadier:integer":
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp struct {
				Flags struct {
					Unused     uint8
					MaxPresent bool
					MinPresent bool
			...
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpFlagsPacked uint8
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpFlagsPacked)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Flags.MinPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpFlagsPacked>>0&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Flags.MaxPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpFlagsPacked>>1&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Flags.Unused = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpFlagsPacked >> 2 & 63
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Flags.MinPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMin1Tmp int32
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMin1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMin1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMinTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMinTmp
			}
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Flags.MaxPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMax1Tmp int32
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMax1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMax1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMaxTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmpMaxTmp
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesBrigadierIntegerTmp
		case "brigadier:long":
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp struct {
				Flags struct {
					Unused     uint8
					MaxPresent bool
					MinPresent bool
			...
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpFlagsPacked uint8
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpFlagsPacked)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Flags.MinPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpFlagsPacked>>0&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Flags.MaxPresent = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpFlagsPacked>>1&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Flags.Unused = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpFlagsPacked >> 2 & 63
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Flags.MinPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMin1Tmp int64
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMin1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMin1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMinTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Min = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMinTmp
			}
			switch CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Flags.MaxPresent {
			case true:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMax1Tmp int64
				err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMax1Tmp)
				if err != nil {
					return
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMax1Tmp
			default:
				var CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMaxTmp struct {
				}
				CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp.Max = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmpMaxTmp
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesBrigadierLongTmp
		case "brigadier:string":
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierStringTmp string
			var CommandNodeExtraNodeData2TmpPropertiesBrigadierStringTmpKey int32
			CommandNodeExtraNodeData2TmpPropertiesBrigadierStringTmpKey, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2TmpPropertiesBrigadierStringTmp, err = proto_base.ErroringIndex(CommandNodeExtraNodeData2TmpPropertiesBrigadierStringTmpMap, CommandNodeExtraNodeData2TmpPropertiesBrigadierStringTmpKey)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesBrigadierStringTmp
		case "minecraft:angle":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftAngleTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftAngleTmp
		case "minecraft:block_pos":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftBlockPosTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftBlockPosTmp
		case "minecraft:block_predicate":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftBlockPredicateTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftBlockPredicateTmp
		case "minecraft:block_state":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftBlockStateTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftBlockStateTmp
		case "minecraft:color":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftColorTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftColorTmp
		case "minecraft:column_pos":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftColumnPosTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftColumnPosTmp
		case "minecraft:component":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftComponentTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftComponentTmp
		case "minecraft:dialog":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftDialogTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftDialogTmp
		case "minecraft:dimension":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftDimensionTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftDimensionTmp
		case "minecraft:entity":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmp struct {
				Unused            uint8
				OnlyAllowPlayers  bool
				OnlyAllowEntities bool
			}
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmpPacked uint8
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmpPacked)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmp.OnlyAllowEntities = CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmpPacked>>0&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmp.OnlyAllowPlayers = CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmpPacked>>1&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmp.Unused = CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmpPacked >> 2 & 63
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityTmp
		case "minecraft:entity_anchor":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityAnchorTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftEntityAnchorTmp
		case "minecraft:float_range":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftFloatRangeTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftFloatRangeTmp
		case "minecraft:function":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftFunctionTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftFunctionTmp
		case "minecraft:game_profile":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftGameProfileTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftGameProfileTmp
		case "minecraft:gamemode":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftGamemodeTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftGamemodeTmp
		case "minecraft:heightmap":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftHeightmapTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftHeightmapTmp
		case "minecraft:hex_color":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftHexColorTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftHexColorTmp
		case "minecraft:int_range":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftIntRangeTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftIntRangeTmp
		case "minecraft:item_predicate":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftItemPredicateTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftItemPredicateTmp
		case "minecraft:item_slot":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftItemSlotTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftItemSlotTmp
		case "minecraft:item_stack":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftItemStackTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftItemStackTmp
		case "minecraft:message":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftMessageTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftMessageTmp
		case "minecraft:nbt":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftNbtTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftNbtTmp
		case "minecraft:nbt_path":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftNbtPathTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftNbtPathTmp
		case "minecraft:objective":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftObjectiveTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftObjectiveTmp
		case "minecraft:objective_criteria":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftObjectiveCriteriaTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftObjectiveCriteriaTmp
		case "minecraft:operation":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftOperationTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftOperationTmp
		case "minecraft:particle":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftParticleTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftParticleTmp
		case "minecraft:resource":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceTmp struct {
				Registry string
			}
			CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceTmp.Registry, err = proto_base.DecodeString(r)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceTmp
		case "minecraft:resource_key":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceKeyTmp struct {
				Registry string
			}
			CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceKeyTmp.Registry, err = proto_base.DecodeString(r)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceKeyTmp
		case "minecraft:resource_location":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceLocationTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceLocationTmp
		case "minecraft:resource_or_tag":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceOrTagTmp struct {
				Registry string
			}
			CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceOrTagTmp.Registry, err = proto_base.DecodeString(r)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceOrTagTmp
		case "minecraft:resource_or_tag_key":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceOrTagKeyTmp struct {
				Registry string
			}
			CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceOrTagKeyTmp.Registry, err = proto_base.DecodeString(r)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceOrTagKeyTmp
		case "minecraft:resource_selector":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceSelectorTmp struct {
				Registry string
			}
			CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceSelectorTmp.Registry, err = proto_base.DecodeString(r)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftResourceSelectorTmp
		case "minecraft:rotation":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftRotationTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftRotationTmp
		case "minecraft:score_holder":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmp struct {
				Unused        uint8
				AllowMultiple bool
			}
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmpPacked uint8
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmpPacked)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmp.AllowMultiple = CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmpPacked>>0&1 == 1
			CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmp.Unused = CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmpPacked >> 1 & 127
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreHolderTmp
		case "minecraft:scoreboard_slot":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreboardSlotTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftScoreboardSlotTmp
		case "minecraft:swizzle":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftSwizzleTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftSwizzleTmp
		case "minecraft:team":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftTeamTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftTeamTmp
		case "minecraft:template_mirror":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftTemplateMirrorTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftTemplateMirrorTmp
		case "minecraft:template_rotation":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftTemplateRotationTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftTemplateRotationTmp
		case "minecraft:time":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftTimeTmp struct {
				Min int32
			}
			err = binary.Read(r, binary.BigEndian, &CommandNodeExtraNodeData2TmpPropertiesMinecraftTimeTmp.Min)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftTimeTmp
		case "minecraft:uuid":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftUuidTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftUuidTmp
		case "minecraft:vec2":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftVec2Tmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftVec2Tmp
		case "minecraft:vec3":
			var CommandNodeExtraNodeData2TmpPropertiesMinecraftVec3Tmp struct {
			}
			CommandNodeExtraNodeData2Tmp.Properties = CommandNodeExtraNodeData2TmpPropertiesMinecraftVec3Tmp
		}
		switch ret.Flags.HasCustomSuggestions {
		case true:
			var CommandNodeExtraNodeData2TmpSuggestionType1Tmp string
			CommandNodeExtraNodeData2TmpSuggestionType1Tmp, err = proto_base.DecodeString(r)
			if err != nil {
				return
			}
			CommandNodeExtraNodeData2Tmp.SuggestionType = CommandNodeExtraNodeData2TmpSuggestionType1Tmp
		default:
			var CommandNodeExtraNodeData2TmpSuggestionTypeTmp struct {
			}
			CommandNodeExtraNodeData2Tmp.SuggestionType = CommandNodeExtraNodeData2TmpSuggestionTypeTmp
		}
...
func (ret *CommandNode) Encode(w io.Writer) (err error) {
	...
	case 2:
		...
		case "brigadier:double":
			...
			var CommandNodeExtraNodeDataPropertiesFlagsPacked uint8
			CommandNodeExtraNodeDataPropertiesFlagsPacked |= (proto_base.Bool2uint8(CommandNodeExtraNodeDataProperties.Flags.MinPresent) & 0x1) << 0x0
			CommandNodeExtraNodeDataPropertiesFlagsPacked |= (proto_base.Bool2uint8(CommandNodeExtraNodeDataProperties.Flags.MaxPresent) & 0x1) << 0x1
			CommandNodeExtraNodeDataPropertiesFlagsPacked |= (uint8(CommandNodeExtraNodeDataProperties.Flags.Unused) & 0x3F) << 0x2
			err = binary.Write(w, binary.BigEndian, CommandNodeExtraNodeDataPropertiesFlagsPacked)
			if err != nil {
				return
			}
			switch CommandNodeExtraNodeDataProperties.Flags.MinPresent {
			case true:
			...
			switch CommandNodeExtraNodeDataProperties.Flags.MaxPresent {
			case true:
		...
		case "minecraft:entity":
			...
			var CommandNodeExtraNodeDataPropertiesPacked uint8
			CommandNodeExtraNodeDataPropertiesPacked |= (proto_base.Bool2uint8(CommandNodeExtraNodeDataProperties.OnlyAllowEntities) & 0x1) << 0x0
			CommandNodeExtraNodeDataPropertiesPacked |= (proto_base.Bool2uint8(CommandNodeExtraNodeDataProperties.OnlyAllowPlayers) & 0x1) << 0x1
			CommandNodeExtraNodeDataPropertiesPacked |= (uint8(CommandNodeExtraNodeDataProperties.Unused) & 0x3F) << 0x2
			err = binary.Write(w, binary.BigEndian, CommandNodeExtraNodeDataPropertiesPacked)
			if err != nil {
				return
			}
		case "minecraft:entity_anchor":
		...
		case "minecraft:score_holder":
			...
			var CommandNodeExtraNodeDataPropertiesPacked uint8
			CommandNodeExtraNodeDataPropertiesPacked |= (proto_base.Bool2uint8(CommandNodeExtraNodeDataProperties.AllowMultiple) & 0x1) << 0x0
			CommandNodeExtraNodeDataPropertiesPacked |= (uint8(CommandNodeExtraNodeDataProperties.Unused) & 0x7F) << 0x1
			err = binary.Write(w, binary.BigEndian, CommandNodeExtraNodeDataPropertiesPacked)
			if err != nil {
				return
			}
...
func (ret *Position) Decode(r io.ReadSeeker) (err error) {
	...
	ret.Y = int16(PositionPacked >> 0 & 4095)
	if ret.Y >= 1<<11 {
		ret.Y -= 1 << 12
	}
	ret.Z = int32(PositionPacked >> 12 & 67108863)
	if ret.Z >= 1<<25 {
		ret.Z -= 1 << 26
	}
...
func (ret *LoginToClientPacketSuccess) Decode(r io.ReadSeeker) (err error) {
	...
	_, err = io.ReadFull(r, ret.SessionId[:])
	if err != nil {
		return
	}
	return
...
var PlayToClientSlotDisplayTypeMap = map[int32]string{0: "empty", 1: "any_fuel", 10: "composite", 2: "with_any_potion", 3: "only_with_component", 4: "item", 5: "item_stack", 6: "tag", 7: "dyed", 8: "smithing_trim", 9: "with_remainder"}
...
func (ret *PlayToClientSlotDisplay) Decode(r io.ReadSeeker) (err error) {
	...
	case "dyed":
		var PlayToClientSlotDisplayDataDyedTmp struct {
			Dye    PlayToClientSlotDisplay
			Target PlayToClientSlotDisplay
		}
		err = PlayToClientSlotDisplayDataDyedTmp.Dye.Decode(r)
		if err != nil {
			return
		}
		err = PlayToClientSlotDisplayDataDyedTmp.Target.Decode(r)
		if err != nil {
			return
		}
		ret.Data = PlayToClientSlotDisplayDataDyedTmp
	case "empty":
	...
	case "only_with_component":
		var PlayToClientSlotDisplayDataOnlyWithComponentTmp struct {
			Source    PlayToClientSlotDisplay
			Component IDSet
		}
		err = PlayToClientSlotDisplayDataOnlyWithComponentTmp.Source.Decode(r)
		if err != nil {
			return
		}
		err = PlayToClientSlotDisplayDataOnlyWithComponentTmp.Component.Decode(r)
		if err != nil {
			return
		}
		ret.Data = PlayToClientSlotDisplayDataOnlyWithComponentTmp
	case "smithing_trim":
	...
	case "with_any_potion":
		var PlayToClientSlotDisplayDataWithAnyPotionTmp struct {
			Display PlayToClientSlotDisplay
		}
		err = PlayToClientSlotDisplayDataWithAnyPotionTmp.Display.Decode(r)
		if err != nil {
			return
		}
		ret.Data = PlayToClientSlotDisplayDataWithAnyPotionTmp
	case "with_remainder":
...
var PlayToClientSlotDisplayTypeReverseMap = map[string]int32{"empty": 0, "any_fuel": 1, "composite": 10, "with_any_potion": 2, "only_with_component": 3, "item": 4, "item_stack": 5, "tag": 6, "dyed": 7, "smithing_trim": 8, "with_remainder": 9}
...
func (ret *PlayToClientSlotDisplay) Encode(w io.Writer) (err error) {
	...
	case "dyed":
		...
		PlayToClientSlotDisplayDataDyeEncTmp := PlayToClientSlotDisplayData.Dye
		err = PlayToClientSlotDisplayDataDyeEncTmp.Encode(w)
		if err != nil {
			return
		}
		PlayToClientSlotDisplayDataTargetEncTmp := PlayToClientSlotDisplayData.Target
		err = PlayToClientSlotDisplayDataTargetEncTmp.Encode(w)
		if err != nil {
			return
		}
	case "empty":
	...
	case "only_with_component":
		...
		PlayToClientSlotDisplayDataSourceEncTmp := PlayToClientSlotDisplayData.Source
		err = PlayToClientSlotDisplayDataSourceEncTmp.Encode(w)
		if err != nil {
			return
		}
		PlayToClientSlotDisplayDataComponentEncTmp := PlayToClientSlotDisplayData.Component
		err = PlayToClientSlotDisplayDataComponentEncTmp.Encode(w)
		if err != nil {
			return
		}
	case "smithing_trim":
	...
	case "with_any_potion":
		...
		PlayToClientSlotDisplayDataDisplayEncTmp := PlayToClientSlotDisplayData.Display
		err = PlayToClientSlotDisplayDataDisplayEncTmp.Encode(w)
		if err != nil {
			return
		}
	case "with_remainder":
...
func (ret *PlayToClientPacket) Decode(r io.ReadSeeker) (err error) {
	...
	case "game_rule_values":
		var PlayToClientPacketParamsGameRuleValuesTmp PlayToClientPacketGameRuleValues
		err = PlayToClientPacketParamsGameRuleValuesTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToClientPacketParamsGameRuleValuesTmp
	...
	case "low_disk_space_warning":
		var PlayToClientPacketParamsLowDiskSpaceWarningTmp PlayToClientPacketLowDiskSpaceWarning
		err = PlayToClientPacketParamsLowDiskSpaceWarningTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToClientPacketParamsLowDiskSpaceWarningTmp
	case "map":
...
var PlayToClientPacketNameReverseMap = map[string]int32{"bundle_delimiter": 0x00, "spawn_entity": 0x01, "animation": 0x02, "statistics": 0x03, "acknowledge_player_digging": 0x04, "block_break_animation": 0x05, "tile_entity_data": 0x06, "block_action": 0x07, "block_change": 0x08, "boss_bar": 0x09, "difficulty": 0x0a, "chunk_batch_finished": 0x0b, "chunk_batch_start": 0x0c, "chunk_biomes": 0x0d, "clear_titles": 0x0e, "tab_complete": 0x0f, "declare_commands": 0x10, "close_window": 0x11, "window_items": 0x12, "craft_progress_bar": 0x13, "set_slot": 0x14, "cookie_request": 0x15, "set_cooldown": 0x16, "chat_suggestions": 0x17, "custom_payload": 0x18, "damage_event": 0x19, "debug_block_value": 0x1a, "debug_chunk_value": 0x1b, "debug_entity_value": 0x1c, "debug_event": 0x1d, "debug_sample": 0x1e, "hide_message": 0x1f, "kick_disconnect": 0x20, "profileless_chat": 0x21, "entity_status": 0x22, "sync_entity_position": 0x23, "explosion": 0x24, "unload_chunk": 0x25, "game_state_change": 0x26, "game_rule_values": 0x27, "game_test_highlight_pos": 0x28, "open_horse_window": 0x29, "hurt_animation": 0x2a, "initialize_world_border": 0x2b, "keep_alive": 0x2c, "map_chunk": 0x2d, "world_event": 0x2e, "world_particles": 0x2f, "update_light": 0x30, "login": 0x31, "low_disk_space_warning": 0x32, "map": 0x33, "trade_list": 0x34, "rel_entity_move": 0x35, "entity_move_look": 0x36, "move_minecart": 0x37, "entity_look": 0x38, "vehicle_move": 0x39, "open_book": 0x3a, "open_window": 0x3b, "open_sign_entity": 0x3c, "ping": 0x3d, "ping_response": 0x3e, "craft_recipe_response": 0x3f, "abilities": 0x40, "player_chat": 0x41, "end_combat_event": 0x42, "enter_combat_event": 0x43, "death_combat_event": 0x44, "player_remove": 0x45, "player_info": 0x46, "face_player": 0x47, "position": 0x48, "player_rotation": 0x49, "recipe_book_add": 0x4a, "recipe_book_remove": 0x4b, "recipe_book_settings": 0x4c, "entity_destroy": 0x4d, "remove_entity_effect": 0x4e, "reset_score": 0x4f, "remove_resource_pack": 0x50, "add_resource_pack": 0x51, "respawn": 0x52, "entity_head_rotation": 0x53, "multi_block_change": 0x54, "select_advancement_tab": 0x55, "server_data": 0x56, "action_bar": 0x57, "world_border_center": 0x58, "world_border_lerp_size": 0x59, "world_border_size": 0x5a, "world_border_warning_delay": 0x5b, "world_border_warning_reach": 0x5c, "camera": 0x5d, "update_view_position": 0x5e, "update_view_distance": 0x5f, "set_cursor_item": 0x60, "spawn_position": 0x61, "scoreboard_display_objective": 0x62, "entity_metadata": 0x63, "attach_entity": 0x64, "entity_velocity": 0x65, "entity_equipment": 0x66, "experience": 0x67, "update_health": 0x68, "held_item_slot": 0x69, "scoreboard_objective": 0x6a, "set_passengers": 0x6b, "set_player_inventory": 0x6c, "teams": 0x6d, "scoreboard_score": 0x6e, "simulation_distance": 0x6f, "set_title_subtitle": 0x70, "update_time": 0x71, "set_title_text": 0x72, "set_title_time": 0x73, "entity_sound_effect": 0x74, "sound_effect": 0x75, "start_configuration": 0x76, "stop_sound": 0x77, "store_cookie": 0x78, "system_chat": 0x79, "playerlist_header": 0x7a, "nbt_query_response": 0x7b, "collect": 0x7c, "entity_teleport": 0x7d, "test_instance_block_status": 0x7e, "set_ticking_state": 0x7f, "step_tick": 0x80, "transfer": 0x81, "advancements": 0x82, "entity_update_attributes": 0x83, "entity_effect": 0x84, "declare_recipes": 0x85, "tags": 0x86, "set_projectile_power": 0x87, "custom_report_details": 0x88, "server_links": 0x89, "tracked_waypoint": 0x8a, "clear_dialog": 0x8b, "show_dialog": 0x8c}
...
func (ret *PlayToClientPacket) Encode(w io.Writer) (err error) {
	...
	case "game_rule_values":
		PlayToClientPacketParams, ok := ret.Params.(PlayToClientPacketGameRuleValues)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
	...
	case "low_disk_space_warning":
		PlayToClientPacketParams, ok := ret.Params.(PlayToClientPacketLowDiskSpaceWarning)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
...
type PlayToClientPacketDeclareRecipes struct {
	...
	StoneCutterRecipes []struct {
		Input         []int32
		OptionDisplay PlayToClientSlotDisplay
		RecipePresent bool
		Recipe        any
	}
}
...
func (ret *PlayToClientPacketDeclareRecipes) Decode(r io.ReadSeeker) (err error) {
	var lPlayToClientPacketDeclareRecipesItemSets int32
	lPlayToClientPacketDeclareRecipesItemSets, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
	ret.ItemSets = []struct {
	...
	for range lPlayToClientPacketDeclareRecipesItemSets {
		var PlayToClientPacketDeclareRecipesItemSetsElement struct {
			Key   IDSet
			Items []int32
		}
		err = PlayToClientPacketDeclareRecipesItemSetsElement.Key.Decode(r)
		if err != nil {
			return
		}
		var lPlayToClientPacketDeclareRecipesItemSetsElementItems int32
		lPlayToClientPacketDeclareRecipesItemSetsElementItems, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		PlayToClientPacketDeclareRecipesItemSetsElement.Items = []int32{}
		for range lPlayToClientPacketDeclareRecipesItemSetsElementItems {
			var PlayToClientPacketDeclareRecipesItemSetsElementItemsElement int32
			PlayToClientPacketDeclareRecipesItemSetsElementItemsElement, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			PlayToClientPacketDeclareRecipesItemSetsElement.Items = append(PlayToClientPacketDeclareRecipesItemSetsElement.Items, PlayToClientPacketDeclareRecipesItemSetsElementItemsElement)
		}
		ret.ItemSets = append(ret.ItemSets, PlayToClientPacketDeclareRecipesItemSetsElement)
	}
	...
	for range lPlayToClientPacketDeclareRecipesStoneCutterRecipes {
		...
		var lPlayToClientPacketDeclareRecipesStoneCutterRecipesElementInput int32
		lPlayToClientPacketDeclareRecipesStoneCutterRecipesElementInput, err = proto_base.DecodeVarInt(r)
		if err != nil {
			return
		}
		PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.Input = []int32{}
		for range lPlayToClientPacketDeclareRecipesStoneCutterRecipesElementInput {
			var PlayToClientPacketDeclareRecipesStoneCutterRecipesElementInputElement int32
			PlayToClientPacketDeclareRecipesStoneCutterRecipesElementInputElement, err = proto_base.DecodeVarInt(r)
			if err != nil {
				return
			}
			PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.Input = append(PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.Input, PlayToClientPacketDeclareRecipesStoneCutterRecipesElementInputElement)
		}
		err = PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.OptionDisplay.Decode(r)
		if err != nil {
			return
		}
		err = binary.Read(r, binary.BigEndian, &PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.RecipePresent)
		if err != nil {
			return
		}
		switch PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.RecipePresent {
		case true:
			var PlayToClientPacketDeclareRecipesStoneCutterRecipesElementRecipeTrueTmp struct {
				Result Slot
			}
			err = PlayToClientPacketDeclareRecipesStoneCutterRecipesElementRecipeTrueTmp.Result.Decode(r)
			if err != nil {
				return
			}
			PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.Recipe = PlayToClientPacketDeclareRecipesStoneCutterRecipesElementRecipeTrueTmp
		default:
			var PlayToClientPacketDeclareRecipesStoneCutterRecipesElementRecipeTmp struct {
			}
			PlayToClientPacketDeclareRecipesStoneCutterRecipesElement.Recipe = PlayToClientPacketDeclareRecipesStoneCutterRecipesElementRecipeTmp
		}
...
func (ret *PlayToClientPacketDeclareRecipes) Encode(w io.Writer) (err error) {
	err = proto_base.EncodeVarInt(w, int32(len(ret.ItemSets)))
	if err != nil {
		return
	}
	for iPlayToClientPacketDeclareRecipesItemSets := range len(ret.ItemSets) {
		PlayToClientPacketDeclareRecipesItemSetsInnerKeyEncTmp := ret.ItemSets[iPlayToClientPacketDeclareRecipesItemSets].Key
		err = PlayToClientPacketDeclareRecipesItemSetsInnerKeyEncTmp.Encode(w)
		if err != nil {
			return
		}
		err = proto_base.EncodeVarInt(w, int32(len(ret.ItemSets[iPlayToClientPacketDeclareRecipesItemSets].Items)))
		if err != nil {
			return
		}
		for iPlayToClientPacketDeclareRecipesItemSetsInnerItems := range len(ret.ItemSets[iPlayToClientPacketDeclareRecipesItemSets].Items) {
			err = proto_base.EncodeVarInt(w, ret.ItemSets[iPlayToClientPacketDeclareRecipesItemSets].Items[iPlayToClientPacketDeclareRecipesItemSetsInnerItems])
			if err != nil {
				return
			}
		}
	...
	for iPlayToClientPacketDeclareRecipesStoneCutterRecipes := range len(ret.StoneCutterRecipes) {
		err = proto_base.EncodeVarInt(w, int32(len(ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].Input)))
		if err != nil {
			return
		}
		for iPlayToClientPacketDeclareRecipesStoneCutterRecipesInnerInput := range len(ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].Input) {
			err = proto_base.EncodeVarInt(w, ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].Input[iPlayToClientPacketDeclareRecipesStoneCutterRecipesInnerInput])
			if err != nil {
				return
			}
		}
		PlayToClientPacketDeclareRecipesStoneCutterRecipesInnerOptionDisplayEncTmp := ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].OptionDisplay
		err = PlayToClientPacketDeclareRecipesStoneCutterRecipesInnerOptionDisplayEncTmp.Encode(w)
		if err != nil {
			return
		}
		err = binary.Write(w, binary.BigEndian, ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].RecipePresent)
		if err != nil {
			return
		}
		switch ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].RecipePresent {
		case true:
			PlayToClientPacketDeclareRecipesStoneCutterRecipesInnerRecipe, ok := ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].Recipe.(struct {
				Result Slot
			})
			if !ok {
				err = proto_base.BadTypeError
			...
			PlayToClientPacketDeclareRecipesStoneCutterRecipesInnerRecipeResultEncTmp := PlayToClientPacketDeclareRecipesStoneCutterRecipesInnerRecipe.Result
			err = PlayToClientPacketDeclareRecipesStoneCutterRecipesInnerRecipeResultEncTmp.Encode(w)
			if err != nil {
				return
			}
		default:
			_, ok := ret.StoneCutterRecipes[iPlayToClientPacketDeclareRecipesStoneCutterRecipes].Recipe.(struct {
			})
			if !ok {
				err = proto_base.BadTypeError
				return
...
func (ret *PlayToClientPacketEntityEquipment) Decode(r io.ReadSeeker) (err error) {
	...
	ret.Equipments = []struct {
		Slot int8
		Item Slot
	}{}
	for {
		var PlayToClientPacketEntityEquipmentEquipmentsHeader uint8
		err = binary.Read(r, binary.BigEndian, &PlayToClientPacketEntityEquipmentEquipmentsHeader)
		if err == io.EOF {
			err = nil
			break
		}
		...
		PlayToClientPacketEntityEquipmentEquipmentsHasMore := PlayToClientPacketEntityEquipmentEquipmentsHeader&128 != 0
		var PlayToClientPacketEntityEquipmentEquipmentsElement struct {
			Slot int8
			Item Slot
		}
		err = binary.Read(r, binary.BigEndian, &PlayToClientPacketEntityEquipmentEquipmentsElement.Slot)
		if err != nil {
			return
		}
		err = PlayToClientPacketEntityEquipmentEquipmentsElement.Item.Decode(r)
		if err != nil {
			return
		}
		ret.Equipments = append(ret.Equipments, PlayToClientPacketEntityEquipmentEquipmentsElement)
		if !PlayToClientPacketEntityEquipmentEquipmentsHasMore {
			break
		}
	}
	return
...
func (ret *PlayToClientPacketEntityEquipment) Encode(w io.Writer) (err error) {
	...
	for iPlayToClientPacketEntityEquipmentEquipments, PlayToClientPacketEntityEquipmentEquipmentsElem := range ret.Equipments {
		if iPlayToClientPacketEntityEquipmentEquipments != len(ret.Equipments)-1 {
			err = binary.Write(w, binary.BigEndian, int8(uint8(PlayToClientPacketEntityEquipmentEquipmentsElem.Slot)|128))
			if err != nil {
				return
			}
		} else {
			err = binary.Write(w, binary.BigEndian, PlayToClientPacketEntityEquipmentEquipmentsElem.Slot)
			if err != nil {
				return
			}
		}
		PlayToClientPacketEntityEquipmentEquipmentsItemEncTmp := PlayToClientPacketEntityEquipmentEquipmentsElem.Item
		err = PlayToClientPacketEntityEquipmentEquipmentsItemEncTmp.Encode(w)
		if err != nil {
			return
		}
	}
...
type PlayToClientPacketGameRuleValues struct {
	Values []struct {
		Key   string
		Value string
	}
...
func (ret *PlayToClientPacketGameRuleValues) Decode(r io.ReadSeeker) (err error) {
	var lPlayToClientPacketGameRuleValuesValues int32
	lPlayToClientPacketGameRuleValuesValues, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
	ret.Values = []struct {
	...
	for range lPlayToClientPacketGameRuleValuesValues {
		var PlayToClientPacketGameRuleValuesValuesElement struct {
			Key   string
			Value string
		}
		PlayToClientPacketGameRuleValuesValuesElement.Key, err = proto_base.DecodeString(r)
		if err != nil {
			return
		}
		PlayToClientPacketGameRuleValuesValuesElement.Value, err = proto_base.DecodeString(r)
		if err != nil {
			return
		}
		ret.Values = append(ret.Values, PlayToClientPacketGameRuleValuesValuesElement)
	}
	return
}
func (ret *PlayToClientPacketGameRuleValues) Encode(w io.Writer) (err error) {
	err = proto_base.EncodeVarInt(w, int32(len(ret.Values)))
	if err != nil {
		return
	}
	for iPlayToClientPacketGameRuleValuesValues := range len(ret.Values) {
		err = proto_base.EncodeString(w, ret.Values[iPlayToClientPacketGameRuleValuesValues].Key)
		if err != nil {
			return
		}
		err = proto_base.EncodeString(w, ret.Values[iPlayToClientPacketGameRuleValuesValues].Value)
		if err != nil {
			return
		}
	}
...
type PlayToClientPacketLowDiskSpaceWarning struct {
}

func (ret *PlayToClientPacketLowDiskSpaceWarning) Decode(r io.ReadSeeker) (err error) {
	return
}
func (ret *PlayToClientPacketLowDiskSpaceWarning) Encode(w io.Writer) (err error) {
	return
}
...
func (ret *PlayToClientPacketMultiBlockChange) Decode(r io.ReadSeeker) (err error) {
	...
	ret.ChunkCoordinates.Y = int32(PlayToClientPacketMultiBlockChangeChunkCoordinatesPacked >> 0 & 1048575)
	if ret.ChunkCoordinates.Y >= 1<<19 {
		ret.ChunkCoordinates.Y -= 1 << 20
	}
	ret.ChunkCoordinates.Z = int32(PlayToClientPacketMultiBlockChangeChunkCoordinatesPacked >> 20 & 4194303)
	if ret.ChunkCoordinates.Z >= 1<<21 {
		ret.ChunkCoordinates.Z -= 1 << 22
	}
	ret.ChunkCoordinates.X = int32(PlayToClientPacketMultiBlockChangeChunkCoordinatesPacked >> 42 & 4194303)
...
func (ret *PlayToServerPacket) Decode(r io.ReadSeeker) (err error) {
	...
	case "attack":
		var PlayToServerPacketParamsAttackTmp PlayToServerPacketAttack
		err = PlayToServerPacketParamsAttackTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToServerPacketParamsAttackTmp
	case "block_dig":
	...
	case "container_button_click":
		var PlayToServerPacketParamsContainerButtonClickTmp PlayToServerPacketContainerButtonClick
		err = PlayToServerPacketParamsContainerButtonClickTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToServerPacketParamsContainerButtonClickTmp
	case "cookie_response":
	...
	case "set_game_rule":
		var PlayToServerPacketParamsSetGameRuleTmp PlayToServerPacketSetGameRule
		err = PlayToServerPacketParamsSetGameRuleTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToServerPacketParamsSetGameRuleTmp
	case "set_slot_state":
	...
	case "spectator_action":
		var PlayToServerPacketParamsSpectatorActionTmp PlayToServerPacketSpectatorAction
		err = PlayToServerPacketParamsSpectatorActionTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToServerPacketParamsSpectatorActionTmp
	case "steer_boat":
	...
	case "teleport_to_entity":
		var PlayToServerPacketParamsTeleportToEntityTmp PlayToServerPacketTeleportToEntity
		err = PlayToServerPacketParamsTeleportToEntityTmp.Decode(r)
		if err != nil {
			return
		}
		ret.Params = PlayToServerPacketParamsTeleportToEntityTmp
...
func (ret *PlayToServerPacket) Encode(w io.Writer) (err error) {
	...
	case "attack":
		PlayToServerPacketParams, ok := ret.Params.(PlayToServerPacketAttack)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
	...
	case "container_button_click":
		PlayToServerPacketParams, ok := ret.Params.(PlayToServerPacketContainerButtonClick)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
	...
	case "set_game_rule":
		PlayToServerPacketParams, ok := ret.Params.(PlayToServerPacketSetGameRule)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
	...
	case "spectator_action":
		PlayToServerPacketParams, ok := ret.Params.(PlayToServerPacketSpectatorAction)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
	...
	case "teleport_to_entity":
		PlayToServerPacketParams, ok := ret.Params.(PlayToServerPacketTeleportToEntity)
		if !ok {
			err = proto_base.BadTypeError
			return
		}
...
type PlayToServerPacketAttack struct {
	EntityId int32
}

func (ret *PlayToServerPacketAttack) Decode(r io.ReadSeeker) (err error) {
	ret.EntityId, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
...
func (ret *PlayToServerPacketAttack) Encode(w io.Writer) (err error) {
	err = proto_base.EncodeVarInt(w, ret.EntityId)
	if err != nil {
		return
	}
...
type PlayToServerPacketContainerButtonClick struct {
	WindowId ContainerID
	ButtonId int32
}

func (ret *PlayToServerPacketContainerButtonClick) Decode(r io.ReadSeeker) (err error) {
	err = ret.WindowId.Decode(r)
	if err != nil {
		return
	}
	ret.ButtonId, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
	return
}
func (ret *PlayToServerPacketContainerButtonClick) Encode(w io.Writer) (err error) {
	PlayToServerPacketContainerButtonClickWindowIdEncTmp := ret.WindowId
	err = PlayToServerPacketContainerButtonClickWindowIdEncTmp.Encode(w)
	if err != nil {
		return
	}
	err = proto_base.EncodeVarInt(w, ret.ButtonId)
	if err != nil {
		return
	}
	return
...
type PlayToServerPacketSetGameRule struct {
	Entries []struct {
		Key   string
		Value string
	}
...
func (ret *PlayToServerPacketSetGameRule) Decode(r io.ReadSeeker) (err error) {
	var lPlayToServerPacketSetGameRuleEntries int32
	lPlayToServerPacketSetGameRuleEntries, err = proto_base.DecodeVarInt(r)
	if err != nil {
		return
	}
	ret.Entries = []struct {
	...
	for range lPlayToServerPacketSetGameRuleEntries {
		var PlayToServerPacketSetGameRuleEntriesElement struct {
			Key   string
			Value string
		}
		PlayToServerPacketSetGameRuleEntriesElement.Key, err = proto_base.DecodeString(r)
		if err != nil {
			return
		}
		PlayToServerPacketSetGameRuleEntriesElement.Value, err = proto_base.DecodeString(r)
		if err != nil {
			return
		}
		ret.Entries = append(ret.Entries, PlayToServerPacketSetGameRuleEntriesElement)
	}
	return
}
func (ret *PlayToServerPacketSetGameRule) Encode(w io.Writer) (err error) {
	err = proto_base.EncodeVarInt(w, int32(len(ret.Entries)))
	if err != nil {
		return
	}
	for iPlayToServerPacketSetGameRuleEntries := range len(ret.Entries) {
		err = proto_base.EncodeString(w, ret.Entries[iPlayToServerPacketSetGameRuleEntries].Key)
		if err != nil {
			return
		}
		err = proto_base.EncodeString(w, ret.Entries[iPlayToServerPacketSetGameRuleEntries].Value)
		if err != nil {
			return
		}
	}
...
type PlayToServerPacketSpectatorAction struct {
	SpectateEntityId Optvarint
}

func (ret *PlayToServerPacketSpectatorAction) Decode(r io.ReadSeeker) (err error) {
	err = ret.SpectateEntityId.Decode(r)
	if err != nil {
		return
	}
	return
}
func (ret *PlayToServerPacketSpectatorAction) Encode(w io.Writer) (err error) {
	PlayToServerPacketSpectatorActionSpectateEntityIdEncTmp := ret.SpectateEntityId
	err = PlayToServerPacketSpectatorActionSpectateEntityIdEncTmp.Encode(w)
	if err != nil {
		return
	}
	return
...
type PlayToServerPacketTeleportToEntity struct {
	Target uuid.UUID
}

func (ret *PlayToServerPacketTeleportToEntity) Decode(r io.ReadSeeker) (err error) {
...
func (ret *PlayToServerPacketTeleportToEntity) Encode(w io.Writer) (err error) {
