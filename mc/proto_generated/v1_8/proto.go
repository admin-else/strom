...
func (ret *Slot) Encode(w io.Writer) (err error) {
	...
	default:
		...
		err = binary.Write(w, binary.BigEndian, slotAnon.ItemDamage)
		if err != nil {
			return
		}
		err = slotAnon.NbtData.Encode(w)
		if err != nil {
			return
		}
	}
